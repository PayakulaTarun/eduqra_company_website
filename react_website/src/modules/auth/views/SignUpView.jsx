...
const SignUpView = () => {
  ...
  return (
    ...
    >
      <SEOManager 
        title="Join Eduqra | Start Your AI Learning Journey"
        description="Create an account on Eduqra to access personalized 1-on-1 AI tutoring and adaptive learning tools."
        canonical="/join"
      />
      <div className="auth-container signup">
        <div className="auth-side">
          <img loading="lazy" src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Join Eduqra AI-Powered Learning Community" />
